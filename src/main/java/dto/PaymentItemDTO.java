...
public class PaymentItemDTO {
    ...
    public PaymentItemDTO(int item_id, int category_id, int rentalShop_id, String item_name, String item_detail, int total_quantity,String item_type,double price_per_hour, String item_img, Date created_at, ItemCategoryDTO itemCategoryDTO) {
        this.item_id = item_id;
        this.category_id = category_id;
        this.rentalShop_id = rentalShop_id;
        this.item_name = item_name;
