...
public class RentalReservationDTO {
    ...
    public RentalReservationDTO(int rent_reserv_id, int rentalshop_id, int uuid, Timestamp rental_start, Timestamp rental_end, double total_price, String status, Date created_at) {
